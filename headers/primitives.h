...
public:
            ...
            : Primitive()
    {
        Vertex vertices[] =
                {
                        //Position								//Color							//Texcoords					//Normals
                        glm::vec3(-0.25f, 0.25f, 0.f),			glm::vec3(0.f, 0.f, 0.f),		glm::vec2(0.f, 1.f),		glm::vec3(0.f, 0.f, 1.f),
                        glm::vec3(-0.25f, -0.25f, 0.f),			glm::vec3(0.f, 0.f, 0.f),		glm::vec2(0.f, 0.f),		glm::vec3(0.f, 0.f, 1.f),
                        glm::vec3(0.25f, -0.25f, 0.f),			glm::vec3(0.f, 0.f, 0.f),		glm::vec2(1.f, 0.f),		glm::vec3(0.f, 0.f, 1.f),
                        glm::vec3(0.25f, 0.25f, 0.f),			glm::vec3(0.f, 0.f, 0.f),		glm::vec2(1.f, 1.f),		glm::vec3(0.f, 0.f, 1.f)
                };
        unsigned nrOfVertices = sizeof(vertices) / sizeof(Vertex);
